...
class Server {
    ...
    async render(req, res, pathname, query = {}, parsedUrl) {
        ...
        if (this.nextConfig.poweredByHeader) {
            res.setHeader('X-Powered-By', 'Next.js ' + "8.0.4-canary.21");
        }
        return this.sendHTML(req, res, html);
    }
    async renderToHTMLWithComponents(req, res, pathname, query = {}, opts) {
        const result = await load_components_1.loadComponents(this.distDir, this.buildId, pathname, opts);
        return render_1.renderToHTML(req, res, pathname, query, Object.assign({}, result, opts, { hasAmp: result.hasAmp }));
    }
    async renderToHTML(req, res, pathname, query = {}, { amphtml, hasAmp } = {}) {
        try {
            // To make sure the try/catch is executed
            const html = await this.renderToHTMLWithComponents(req, res, pathname, query, Object.assign({}, this.renderOpts, { amphtml, hasAmp }));
            return html;
        }
        catch (err) {
