...
function getBaseWebpackConfig(dir, { dev = false, isServer = false, buildId, config, target = 'server', entrypoints }) {
    ...
    let webpackConfig = {
        ...
        plugins: [
            ...
            !dev && new all_modules_identified_plugin_1.AllModulesIdentifiedPlugin(),
            ...
            target === 'serverless' && isServer && new serverless_plugin_1.ServerlessPlugin(buildId, { sourceMap: dev }),
            ...
            if (entry && typeof entry !== 'string' && !Array.isArray(entry)) {
                ...
                if (entry['main.js'] && entry['main.js'].length > 0) {
                    entry[constants_1.CLIENT_STATIC_FILES_RUNTIME_MAIN] = [
                        ...entry['main.js'],
                        originalEntry[constants_1.CLIENT_STATIC_FILES_RUNTIME_MAIN]
                    ];
                }
